  ...
  systemd.user.services = {
    saffire-jack = {
      ...
      Service = {
        ...
        ExecStart = "${jack2}/bin/jackd --name saffire --realtime --realtime-priority 88 -d firewire --device guid:0x00130e0401c04de0 --period 64 --nperiods 3 --rate 48000 --duplex --verbose 3";
        TimeoutStartSec = 30;
        TimeoutStopSec = 30;
      };
